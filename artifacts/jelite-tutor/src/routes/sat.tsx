...
const TIPS = [
  ...
  { icon: Target, title: "Focus on Weaknesses", desc: "Use Jelite Tutor's analytics to identify your weak areas and target those topics in your study sessions." },
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <div className="rounded-2xl bg-gradient-to-br from-primary via-primary/90 to-accent/80 p-8 text-center text-white">
        ...
        <p className="mt-2 text-white/80">Join thousands of students who improved their scores with Jelite Tutor's SAT practice materials and AI-powered study tools.</p>
