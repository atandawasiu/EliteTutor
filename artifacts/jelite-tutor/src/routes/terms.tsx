    ...
    <div className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none space-y-8 text-sm leading-relaxed text-foreground">
        <Section title="1. Acceptance of Terms">
          <p>By accessing or using Jelite Tutor ("the Platform", "we", "our", "us"), you agree to be bound by these Terms &amp; Conditions and all applicable laws and regulations. If you do not agree with any part of these terms, you may not use our Platform.</p>
          <p>These terms apply to all visitors, users, students, and any other persons who access or use our services.</p>
        </Section>

        <Section title="2. Description of Service">
          <p>Jelite Tutor is Africa's leading exam preparation platform providing:</p>
          <ul>
        ...
        <Section title="3. User Accounts">
          ...
          <p><strong>Account Security:</strong> You are responsible for maintaining the confidentiality of your account credentials and for all activities that occur under your account. You must immediately notify Jelite Tutor of any unauthorized use of your account.</p>
        ...
        <Section title="6. Intellectual Property">
          <p>All content on the Platform, including but not limited to text, graphics, logos, images, audio clips, video clips, question banks, and software, is the property of Jelite Tutor or its content suppliers and is protected by Nigerian and international intellectual property laws.</p>
          ...
          <p>User-generated content (community posts, discussions) remains the property of the respective users. By posting content, you grant Jelite Tutor a non-exclusive, royalty-free license to use, display, and distribute such content on the Platform.</p>
        </Section>

        <Section title="7. AI-Powered Features">
          <p>Jelite Tutor uses artificial intelligence to provide explanations, study assistance, and personalized learning recommendations. Please note:</p>
          <ul>
        ...
        <Section title="9. Disclaimer of Warranties">
          <p>The Platform is provided on an "as is" and "as available" basis without warranties of any kind, either express or implied. Jelite Tutor does not warrant that:</p>
          <ul>
        ...
        <Section title="10. Limitation of Liability">
          <p>To the maximum extent permitted by applicable law, Jelite Tutor shall not be liable for any indirect, incidental, special, consequential, or punitive damages, including but not limited to loss of profits, data, or goodwill, arising out of or in connection with your use of the Platform.</p>
        ...
        <Section title="14. Contact Us">
          ...
          <ul>
            ...
            <li><strong>Address:</strong> Jelite Tutor, Lagos, Nigeria</li>
          </ul>
        </Section>
      </div>

      <div className="mt-10 rounded-xl border border-border bg-secondary/30 p-5 text-center">
        <p className="text-sm text-muted-foreground">By using Jelite Tutor, you acknowledge that you have read, understood, and agree to be bound by these Terms &amp; Conditions.</p>
